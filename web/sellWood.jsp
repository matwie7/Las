...
<form class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="suma_brutto" disabled>
        </div>
    </div>
</form>

<button type="button" class="btn btn-primary" id="save" style="margin-left: 235px;">Zapisz</button>
...
<script src="${pageContext.request.contextPath}/wood_selling_handler.js"></script>
</body>
</html>
